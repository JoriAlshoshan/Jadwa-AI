...
def calculate_update_economic_indicator():
    ...
    df = pd.read_csv(r"C:\Users\رهف\Desktop\project\Jadwa-AI\JadwaAI\dataset\jadwa_ai_final_dataset.csv")
    ...
    df['economic_indicator'] = df[['establishments_norm','number_of_saudi_employees_norm','project_success_norm']].mean(axis=1)

    # calculate the average economic indicator for each region
